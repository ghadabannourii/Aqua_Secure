...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div>
                <h1 class="text-3xl font-display font-bold text-white">Bienvenue, <?php echo e(explode(' ', $user['name'])[0]); ?> 👋</h1>
                <p class="text-cyan-100/60 text-sm mt-1"><?php echo e($user['email']); ?></p>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div class="glass p-5 rounded-2xl hover-lift">
            <div class="flex items-start justify-between mb-3">
                <div class="w-12 h-12 rounded-xl bg-<?php echo e($stat['color']); ?>-500/10 flex items-center justify-center">
                    <i data-lucide="<?php echo e($stat['icon']); ?>" class="w-6 h-6 text-<?php echo e($stat['color']); ?>-400"></i>
                </div>
            </div>
            <div class="text-2xl font-display font-bold text-white mb-1"><?php echo e($stat['value']); ?></div>
            <div class="text-xs text-cyan-100/60"><?php echo e($stat['label']); ?></div>
        </div>
                    ...
                    <form class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                ...
                                <label class="glass p-3 rounded-xl cursor-pointer hover:border-<?php echo e($priority['color']); ?>-400/40 transition-all">
                                    <input type="radio" name="priority" value="<?php echo e($priority['value']); ?>" class="sr-only peer">
                                    <div class="text-center peer-checked:text-<?php echo e($priority['color']); ?>-400 text-cyan-100/50">
                                        <div class="text-sm font-semibold"><?php echo e($priority['label']); ?></div>
                                    </div>
                                </label>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ripple-button','data' => ['type' => 'button','size' => 'lg','onclick' => 'showToast(\'Déclaration envoyée avec succès\', \'success\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','size' => 'lg','onclick' => 'showToast(\'Déclaration envoyée avec succès\', \'success\')']); ?>
...
<?php endif; ?>
            ...
            <div id="tab-track" class="tab-content hidden">
                ...
                <div class="space-y-3">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $declaration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="glass p-5 rounded-xl hover-lift">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <div class="flex items-center gap-3 mb-2">
                                    <span class="text-sm font-mono font-semibold text-cyan-300"><?php echo e($declaration['id']); ?></span>
                                    <?php if (isset($component)) { $__componentOriginal2ddbc40e602c342e508ac696e52f8719 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2ddbc40e602c342e508ac696e52f8719 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.badge','data' => ['color' => '#'.e($declaration['statusColor'] === 'orange' ? 'f97316' : ($declaration['statusColor'] === 'teal' ? '14b8a6' : '06b6d4')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => '#'.e($declaration['statusColor'] === 'orange' ? 'f97316' : ($declaration['statusColor'] === 'teal' ? '14b8a6' : '06b6d4')).'']); ?>
                                        <?php echo e($declaration['status']); ?>
...
<?php endif; ?>
                                ...
                                <h4 class="text-white font-semibold mb-1"><?php echo e($declaration['type']); ?></h4>
                                <p class="text-cyan-100/60 text-sm">Zone : <?php echo e($declaration['zone']); ?> • <?php echo e($declaration['date']); ?></p>
                            </div>
            ...
            <div id="tab-notify" class="tab-content hidden">
                ...
                <div class="space-y-3">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="glass p-5 rounded-xl hover-lift">
                        <div class="flex gap-4">
                            ...
                            <div class="flex-1">
                                <h4 class="text-white font-semibold mb-1"><?php echo e($notification['title']); ?></h4>
                                <p class="text-cyan-100/60 text-sm mb-2"><?php echo e($notification['message']); ?></p>
                                <p class="text-cyan-100/40 text-xs"><?php echo e($notification['time']); ?></p>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div id="tab-finance" class="tab-content hidden">
                ...
                <div class="space-y-3">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="glass p-5 rounded-xl hover-lift">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 class="text-white font-semibold"><?php echo e($invoice['period']); ?></h4>
                                    <p class="text-cyan-100/60 text-sm"><?php echo e($invoice['date']); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center gap-4">
                                <div class="text-right">
                                    <div class="text-white font-bold"><?php echo e($invoice['amount']); ?></div>
                                    <?php if (isset($component)) { $__componentOriginal2ddbc40e602c342e508ac696e52f8719 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2ddbc40e602c342e508ac696e52f8719 = $attributes; } ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => '#14b8a6']); ?><?php echo e($invoice['status']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal2ddbc40e602c342e508ac696e52f8719)): ?>
<?php $attributes = $__attributesOriginal2ddbc40e602c342e508ac696e52f8719; ?>
<?php unset($__attributesOriginal2ddbc40e602c342e508ac696e52f8719); ?>
