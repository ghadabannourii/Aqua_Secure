...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.badge','data' => ['color' => '#06b6d4','class' => 'hidden sm:inline-flex']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['color' => '#06b6d4','class' => 'hidden sm:inline-flex']); ?>Espace Citoyen <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="flex items-center gap-2">
            ...
            <button onclick="toggleProfileModal()" class="hidden sm:flex items-center gap-2 glass px-3 py-2 rounded-lg text-white/80 hover:text-white transition-colors">
                ...
                <span class="text-xs font-semibold max-w-[120px] truncate"><?php echo e(auth()->user()->name ?? 'Utilisateur'); ?></span>
            </button>
    ...
    <!-- Main Content -->
    <div class="px-4 sm:px-6 py-6 max-w-5xl mx-auto pb-24">
